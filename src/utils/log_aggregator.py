...
class LogAggregator:
    ...
    def _load_config(self, config_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to load config", module="log_aggregator", error=str(e))
            return {
                "logging": {
                    "log_dir": "logs",
                    "max_size": 10485760,  # 10MB
                    "backup_count": 5,
                    "rotation": {"max_days": 30, "compress": True},
                }
            }
    ...
    def rotate_logs(self) -> None:
        ...
        try:
            ...
            logger.error("Failed to rotate logs", module="log_aggregator", error=str(e))
    ...
    def _cleanup_old_archives(self) -> None:
        ...
        try:
            ...
            logger.error(
                "Failed to clean up archives", module="log_aggregator", error=str(e)
            )
    ...
    def start_background_rotation(self) -> None:
        ...
        def rotation_task():
            while True:
                try:
                    ...
                    interval = self.config["metrics"]["intervals"].get(
        ...
        logger.info("Started background log rotation", module="log_aggregator")

    def aggregate_component_logs(
        self, component: str, days: int = 1
    ) -> List[Dict[str, Any]]:
    ...
    def get_log_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Failed to get log stats", module="log_aggregator", error=str(e)
            )
            return {}
